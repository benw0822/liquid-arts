    ...
    <div class="hop-detail-card grid-item" style="margin: 0 auto; margin-bottom: 2rem;">
        <div class="hop-detail-image-wrapper">
             ...
             <div class="hopper-profile-container" style="display: flex;">
                 <img class="hopper-avatar" src="${userAvatar}">
                 ...
                 <div class="hop-interactions">
                    ...
                    <button class="btn-interaction" onclick="window.toggleCardPanel('${hopId}')">
                        <svg class="interaction-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                    </button>
                 </div>
             </div>
        ...
        <div id="card-panel-${hopId}" style="display: none; position: absolute; bottom: 0; left: 0; width: 100%; height: 60%; background: white; border-radius: 16px 16px 0 0; z-index: 70; flex-direction: column; overflow: hidden; box-shadow: 0 -4px 20px rgba(0,0,0,0.3);">
            <div style="padding: 12px 16px; border-bottom: 1px solid #eee; display: flex; justify-content: space-between; align-items: center; background: #fff;">
                <span style="font-weight: 700; font-size: 0.95rem; color: #333;">Comments</span>
                <button onclick="window.toggleCardPanel('${hopId}')" style="background: none; border: none; font-size: 1.5rem; cursor: pointer; color: #888;">&times;</button>
            </div>
            <div id="card-comments-list-${hopId}" style="flex: 1; overflow-y: auto; padding: 16px; background: #f9f9f9;">
                ${commentListHtml}
            </div>
            <div style="padding: 12px; border-top: 1px solid #eee; display: flex; gap: 8px; background: #fff; align-items: center;">
                <input id="card-input-${hopId}" type="text" placeholder="Add a comment..." style="flex: 1; border: 1px solid #ddd; border-radius: 24px; padding: 10px 16px; font-size: 16px; outline: none;">
                <button onclick="window.submitCardPanelComment('${hopId}')" style="background: var(--bg-red); color: white; border: none; border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>
                </button>
            </div>
        </div>
